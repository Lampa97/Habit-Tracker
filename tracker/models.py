...
class Habit(models.Model):
    owner = models.ForeignKey(User, on_delete=models.CASCADE, blank=True, null=True, related_name="habits", verbose_name="Owner")
    ...
    periodicity_in_days = models.PositiveIntegerField(verbose_name="Periodicity in days", default=1, validators=[MaxValueValidator(7), MinValueValidator(1)])
