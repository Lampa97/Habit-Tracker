...
class Habit(models.Model):
    owner = models.ForeignKey(
        User, on_delete=models.CASCADE, blank=True, null=True, related_name="habits", verbose_name="Owner"
    )
    ...
    connected_habit = models.ForeignKey(
        "self", on_delete=models.SET_NULL, related_name="habits", verbose_name="Connected habit", null=True, blank=True
    )
